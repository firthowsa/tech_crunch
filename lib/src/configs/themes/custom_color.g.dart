...
const customcolor1 = Color(0xFF0DEA42);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF0DEA42),
  customcolor1: Color(0xFF006E19),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFF71FF73),
  onCustomcolor1Container: Color(0xFF002203),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF0DEA42),
  customcolor1: Color(0xFF00E63F),
  onCustomcolor1: Color(0xFF003908),
  customcolor1Container: Color(0xFF005310),
  onCustomcolor1Container: Color(0xFF71FF73),
);
